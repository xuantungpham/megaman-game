...
public class ParticularObjectManager {
    ...
    public ParticularObjectManager(GameWorld gameWorld){
        particularObjects = Collections.synchronizedList(new LinkedList<ParticularObject>()); // vì game có nhiều luồng nên dùng synchronizedList để tránh tránh xung đột tài nguyên
